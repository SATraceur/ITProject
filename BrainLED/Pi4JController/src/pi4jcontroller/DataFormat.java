...
public class DataFormat {
    ...
    public String toString() {
        return "DataFormat{" + "dataID=" + dataID + ", blink=" + blink + ", winkLeft=" + winkLeft + ", winkRight=" + winkRight + ", lookLeft=" + lookLeft + ", lookRight=" + lookRight + ", smail=" + smail + ", clench=" + clench + ", smirkLeft=" + smirkLeft + ", smirkRight=" + smirkRight + ", laugh=" + laugh + ", frown=" + frown + ", surprise=" + surprise + ", bawl=" + bawl + ", sob=" + sob + '}';
    }
